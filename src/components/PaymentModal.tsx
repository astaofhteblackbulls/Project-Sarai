...
import { createTransaction, processPayment } from '../api/payments';
...
const PaymentModal: React.FC<PaymentModalProps> = ({
  ...
  const [selectedPaymentMethod, setSelectedPaymentMethod] = useState<'razorpay' | 'cashfree' | 'paytm'>('razorpay');
                ...
                {paymentMethods.map((method) => (
                  ...
                  >
                    <input
                      ...
                      onChange={() => setSelectedPaymentMethod(method.id as 'razorpay' | 'cashfree' | 'paytm')}
            ...
            >
              {isProcessing ? (
                ...
                <>
                  ...
                  <span>Pay {currentCurrency.symbol}{price} {currency} with {paymentMethods.find(m => m.id === selectedPaymentMethod)?.name}</span>
                </>
              )}
            </button>
          </form>
